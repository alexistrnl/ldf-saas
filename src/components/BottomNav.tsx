  ...
  return (
    <>
      <nav className="fixed inset-x-0 bottom-4 z-40 flex justify-center md:hidden">
        <div className="mx-auto flex w-full max-w-sm items-center rounded-full bg-[#020617] px-2 py-2 shadow-[0_8px_30px_rgba(0,0,0,0.8)] border border-white/10">
          {/* Home */}
          <button
            onClick={() => router.push('/home')}
            className={`flex flex-1 flex-col items-center gap-0.5 py-1.5 min-w-[56px] transition-colors ${
          ...
          >
            ...
            <span className={`text-[11px] ${socialActive ? 'text-bitebox' : 'text-slate-300'}`}>Social</span>
          </button>
